...
int main(int argc, char **argv)
{
    ...
    for (int j = 0; j < outer_iterations; j++)
    {
        ...
        #pragma omp parallel private(tid, th_index) shared( level, victim, competing, victim_peterson, flag_peterson, lock_log, index, th_indices)
